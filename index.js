...
app.use("/api/assignments", require("./routes/chapterassignments.router.js"));
app.use("/api/chapters", require("./routes/chapters.router.js"));
app.use("/api/exercises", require("./routes/exercises.router.js"));
